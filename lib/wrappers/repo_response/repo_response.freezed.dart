...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RepoResponse<T>);
}
...
/// @nodoc
class $RepoResponseCopyWith<T,$Res>  {
$RepoResponseCopyWith(RepoResponse<T> _, $Res Function(RepoResponse<T>) __);
}


/// Adds pattern-matching-related methods to [RepoResponse].
extension RepoResponsePatterns<T> on RepoResponse<T> {
...
class Success<T> implements RepoResponse<T> {
...
@override
String toString() {
  return 'RepoResponse<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $RepoResponseCopyWith<T, $Res> {
...
class Error<T> implements RepoResponse<T> {
...
@override
String toString() {
  return 'RepoResponse<$T>.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $RepoResponseCopyWith<T, $Res> {
